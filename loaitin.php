             ...
             <div class="col-md-3 ">
                <ul class="list-group" id="menu">
                    ...
                    <?php 
                        foreach ($menu as $mn) {
                            ?>
                            <li href="#" class="list-group-item menu1"><?= $mn->Ten ?>
                            </li>

                            <ul>
                                <?php
                                $loaitin=$mn->Loaitin;
                                $loaitin=explode(',', $loaitin);
                    ...
                    foreach ($tintuc as $tin) {
                        ...
                        <div class="row-item row">
                            ...
                            <div class="col-md-9">
                                <h3><?= $tin->TieuDe ?></h3>
                                <p><?= $tin->TomTat ?></p>
                                <a class="btn btn-primary" href="chitiet.php?id_tin=<?= $tin->id ?>">Xem tin <span class="glyphicon glyphicon-chevron-right"></span></a>
                            </div>
                            <div class="break"></div>
                        </div>
                        <?php
